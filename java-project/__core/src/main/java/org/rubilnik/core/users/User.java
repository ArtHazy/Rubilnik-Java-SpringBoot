...
@Entity @Table(name = "users") // "User" is reserved keyword in psql
public class User implements Serializable {
    ...
    @JsonManagedReference @OneToMany(cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "author")
    ...
    public Quiz claimQuiz(Quiz quiz){
        quiz.setAuthor(this);
        if (!quizzes.contains(quiz)) quizzes.add(quiz);
        return quiz;
    }
